...
// printUserPhoto = (photoUrl: string): void => {
//   var doc = new jsPDF();
//   doc = this.addImageToPDF(doc, photoUrl); // Agregar la imagen al PDF
//   doc.save('profile_photo.pdf');
// }

// private addImageToPDF(doc: jsPDF, photoUrl: string) : jsPDF {
//   const baseX = 10;
//   const baseY = 10; // Posición Y donde quieres colocar la imagen
//   const imageWidth = 100; // Ancho de la imagen
//   const imageHeight = 100; // Alto de la imagen

//   // La función addImage toma la URL de la imagen, el formato (por ejemplo, 'JPEG', 'PNG'), posición X, posición Y, ancho y alto.
//   doc.addImage(photoUrl, 'JPEG', baseX, baseY, imageWidth, imageHeight);
